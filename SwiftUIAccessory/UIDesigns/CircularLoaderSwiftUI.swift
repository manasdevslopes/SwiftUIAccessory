...
struct CircularLoaderSwiftUI: View {
    var body: some View {
        ZStack{
...
struct CircularLoaderSwiftUI_Previews: PreviewProvider {
        ...
        ZStack{
            ZStack{
                Rectangle()
                    ...
                    .animation(Animation.easeInOut(duration: 1).repeatForever(autoreverses: true), value: circlerotate)
                    .onAppear() {
            ...
            ZStack{
                Rectangle()
                    ...
                    .rotationEffect(.degrees(circlerotate ? 90 : -90))
                    .animation(Animation.easeInOut(duration: 1).repeatForever(autoreverses: true), value: circlerotate2)
                    .onAppear() {
                        self.circlerotate2.toggle()
                    }
                
            }.offset(x: 0, y: 80).rotationEffect(.degrees(45))
            ZStack{
                Rectangle()
                    ...
                    .animation(Animation.easeInOut(duration: 1).repeatForever(autoreverses: true), value: circlerotate3)
                    .onAppear() {
                        self.circlerotate3.toggle()
                    }
                
            }.offset(x: 0, y: 80).rotationEffect(.degrees(90))
            ZStack{
                Rectangle()
                    .foregroundColor(.red)
                    ...
                    .animation(Animation.easeInOut(duration: 1).repeatForever(autoreverses: true), value: circlerotate4)
                    .onAppear() {
                        self.circlerotate4.toggle()
                    }
            }.offset(x: 0, y: 80).rotationEffect(.degrees(135))
            ZStack{
                Rectangle()
                    ...
                    .animation(Animation.easeInOut(duration: 1).repeatForever(autoreverses: true), value: circlerotate5)
                    .onAppear() {
                        self.circlerotate5.toggle()
                    }
            }.offset(x: 0, y: 80).rotationEffect(.degrees(180))
            ZStack{
                Rectangle()
                    ...
                    .animation(Animation.easeInOut(duration: 1).repeatForever(autoreverses: true), value: circlerotate6)
                    .onAppear() {
                        self.circlerotate6.toggle()
                    }
            }.offset(x: 0, y: 80).rotationEffect(.degrees(225))
            ZStack{
                Rectangle()
                    ...
                    .animation(Animation.easeInOut(duration: 1).repeatForever(autoreverses: true), value: circlerotate7)
                    .onAppear() {
                        self.circlerotate7.toggle()
                    }
            }.offset(x: 0, y: 80).rotationEffect(.degrees(270))
            ZStack{
                Rectangle()
                    ...
                    .animation(Animation.easeInOut(duration: 1).repeatForever(autoreverses: true), value: circlerotate8)
                    .onAppear() {
                        self.circlerotate8.toggle()
                    }
            }.offset(x: 0, y: 80).rotationEffect(.degrees(315))
        }
